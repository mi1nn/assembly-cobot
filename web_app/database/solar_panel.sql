...
(1, 1, 'post3', '숏 포스트 3번 설치', 1, '좌측 전단 포스트 설치', TRUE, 600,
 ...
 '[{"code":"CMP-POST-3","name":"숏 포스트 A","category":"구조재","pickup_position":{"x":359.50,"y":-241.74,"z":220.0,"A":4.61,"B":179.12,"C":94.59},"assembly_position":{"x":493.50,"y":274.57,"z":225.0,"A":165.34,"B":-179.58,"C":-105.02}},
...
(2, 1, 'post4', '롱 포스트 4번 설치', 2, '좌측 후단 포스트 설치', TRUE, 600,
 '{"tcp":{"x":0,"y":0,"z":150},"ucs":null,"tool":"gripper_post","fixture":"jig_post","coordinate_system":"BASE","speed":100,"acceleration":200,"pick_distance":60,"place_retreat_distance":50,"place_search_limit_z":0.0,"place_force":30.0,"place_contact_force":20.0,"place_insert_force":12.0,"place_stiffness_z":500.0,"place_search_velocity":10.0,"place_search_acceleration":20.0,"place_search_timeout":null}',
 '[{"code":"CMP-POST-4","name":"롱 포스트 A","category":"구조재","pickup_position":{"x":349.95,"y":-293.97,"z":265.0,"A":3.74,"B":179.21,"C":93.83},"assembly_position":{"x":293.54,"y":278.52,"z":230.0,"A":84.20,"B":-179.06,"C":173.99}},
...
(3, 1, 'post2', '숏 포스트 2 설치', 3, '중앙 전단 포스트 설치', TRUE, 600,
 '{"tcp":{"x":0,"y":0,"z":150},"ucs":null,"tool":"gripper_post","fixture":"jig_post","coordinate_system":"BASE","speed":100,"acceleration":200,"pick_distance":60,"place_retreat_distance":50,"place_search_limit_z":0.0,"place_force":30.0,"place_contact_force":20.0,"place_insert_force":12.0,"place_stiffness_z":500.0,"place_search_velocity":10.0,"place_search_acceleration":20.0,"place_search_timeout":null}',
 '[{"code":"CMP-POST-2","name":"숏 포스트 A","category":"구조재","pickup_position":{"x":428.12,"y":-241.83,"z":220.0,"A":0.35,"B":179.0,"C":90.16},"assembly_position":{"x":488.98,"y":76.43,"z":230.0,"A":163.20,"B":-179.71,"C":-107.01}},
    {"code":"PIN-A","name":"포스트 체결용 핀 A","category":"평행핀","pickup_position":null,"assembly_position":null}]'),
(4, 1, 'post5', '롱 포스트 5 설치', 4, '중앙 후단 포스트 설치', TRUE, 600,
'{"tcp":{"x":0,"y":0,"z":150},"ucs":null,"tool":"gripper_post","fixture":"jig_post","coordinate_system":"BASE","speed":100,"acceleration":200,"pick_distance":60,"place_retreat_distance":50,"place_search_limit_z":0.0,"place_force":30.0,"place_contact_force":20.0,"place_insert_force":12.0,"place_stiffness_z":500.0,"place_search_velocity":10.0,"place_search_acceleration":20.0,"place_search_timeout":null}',
 '[{"code":"CMP-POST-5","name":"롱 포스트 A","category":"구조재","pickup_position":{"x":427.35,"y":-298.33,"z":265.0,"A":173.57,"B":-178.97,"C":-96.51},"assembly_position":{"x":291.81,"y":88.23,"z":230.0,"A":63.03,"B":-179.41,"C":152.76}},
    {"code":"PIN-A","name":"포스트 체결용 핀 A","category":"평행핀","pickup_position":null,"assembly_position":null}]'),
(5, 1, 'post6', '롱 포스트 6 설치', 5, '우측 후단 포스트 설치', TRUE, 600,
'{"tcp":{"x":0,"y":0,"z":150},"ucs":null,"tool":"gripper_post","fixture":"jig_post","coordinate_system":"BASE","speed":100,"acceleration":200,"pick_distance":60,"place_retreat_distance":50,"place_search_limit_z":0.0,"place_force":30.0,"place_contact_force":20.0,"place_insert_force":12.0,"place_stiffness_z":500.0,"place_search_velocity":10.0,"place_search_acceleration":20.0,"place_search_timeout":null}',
 '[{"code":"CMP-POST-6","name":"롱 포스트 A","category":"구조재","pickup_position":{"x":483.90,"y":-241.42,"z":265.0,"A":105.79,"B":179.65,"C":-164.60},"assembly_position":{"x":285.87,"y":-119.55,"z":214.77,"A":143.93,"B":178.63,"C":-126.73}},
    {"code":"PIN-A","name":"포스트 체결용 핀 A","category":"평행핀","pickup_position":null,"assembly_position":null}]'),
(6, 1, 'post1', '숏 포스트 1 설치', 6, '우측 전단 포스트 설치', TRUE, 600,
'{"tcp":{"x":0,"y":0,"z":150},"ucs":null,"tool":"gripper_post","fixture":"jig_post","coordinate_system":"BASE","speed":100,"acceleration":200,"pick_distance":60,"place_retreat_distance":50,"place_search_limit_z":0.0,"place_force":30.0,"place_contact_force":20.0,"place_insert_force":12.0,"place_stiffness_z":500.0,"place_search_velocity":10.0,"place_search_acceleration":20.0,"place_search_timeout":null}',
 '[{"code":"CMP-POST-1","name":"숏 포스트 A","category":"구조재","pickup_position":{"x":491.06,"y":-295.50,"z":220.0,"A":107.47,"B":179.70,"C":-162.62},"assembly_position":{"x":484.19,"y":-122.82,"z":230.0,"A":139.71,"B":179.38,"C":-130.44}},
    {"code":"PIN-A","name":"포스트 체결용 핀 A","category":"평행핀","pickup_position":null,"assembly_position":null}]'),
